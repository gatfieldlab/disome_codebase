...
"""This module provides codon usage related data structures and tools
"""
...
#  Calculated using the stAIcalc utility with ALL valid CDS sequences
CODON_sTAI = {
    'mouse': {
...
# Calculated using the stAIcalc utility with highest RP expressor genes
# -- note -- this is same as highest TR expressor genes
CODON_sTAI_EXP = {
    'mouse': {
